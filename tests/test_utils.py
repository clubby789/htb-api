...
def test_parse_delta():
    ...
    assert parse_delta("10D 10h 10m 10s") == timedelta(days=10, hours=10, minutes=10, seconds=10)
    assert parse_delta("10W 10D 10h") == timedelta(weeks=10, days=10, hours=10)
    assert parse_delta("10W 10D 10h 10m 10s") == timedelta(weeks=10, days=10, hours=10, minutes=10, seconds=10)
